import { layout, escapeHtml, displayName, formatValue } from '../layout.ts';
...
const PROPERTIES: Property[] = [
  ...
  { name: "isPartOf", kind: 'Ref', targets: ["WebPage"], cardinality: "one", required: false },
...
const EXTRA_COLS: string[] = ["datePublished"];
